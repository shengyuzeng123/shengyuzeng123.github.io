...
require(["jquery", "common", "echarts", "imagesLoaded"], function ($, common, echarts) {
    ...
    function createMap(){
        ...
        map.centerAndZoom(new BMap.Point(120.129943,30.289042),17);
    }
    ...
    function addMapOverlay(){
        var markers = [
            {content:"这是米花公司官网",title:"公司地址",imageOffset: {width:0,height:3},position:{lat:30.288714,lng:120.130895}}
        ];
